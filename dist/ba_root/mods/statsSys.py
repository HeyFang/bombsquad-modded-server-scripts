...
def insert_stats():
    ...
    try:
        ...
        ranks = {
            record["pb_id"]: rank + 1 for rank, record in enumerate(sorted_records)
        }

        # Update ranks for currently playing players
        player_ids = [
            entity["account_id"] for entity in ros for player in entity["players"]
        ]
...
def get_top3():
    try:
        ...
        return (
            top_3_v2_ids[0] if len(top_3_v2_ids) > 0 else " ",
