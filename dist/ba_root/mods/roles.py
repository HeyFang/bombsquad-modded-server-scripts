...
all_cmds = {
    "list": USER,
    "me": USER, "stats": USER, "rank": USER,
    "pb": USER,
    "help": USER, "commands": USER, "cmds": USER,

    "hi": VIP,
    "tint": VIP,
    "nv": VIP, "night": VIP,
    "sm": VIP, "slowmo": VIP, "epic": VIP,
    "info": VIP, "gp": VIP,
    "pause": VIP,
    "resume": VIP,
    "maxplayers": VIP, "mp": VIP,
    "lm": VIP,
...
def get_commands_for_role(role: str):
    return role_cmds.get(role, user_cmds)  # Default to user commands if role is not found